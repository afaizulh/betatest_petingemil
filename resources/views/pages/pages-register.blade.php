...
<head>
  ...
  <title>Register - Peti Ngemil</title>
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <div class="d-flex justify-content-center">
                      <img src="assets/img/Register.png" alt="" class="d-flex align-center">
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-12">
                      <button class="btn w-100" style="background-color: #DBD3CD" type="submit">Create Account</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="{{ route('login')}}" style="color: #DFA6A6">Log in</a></p>
                    </div>
                  </form>
